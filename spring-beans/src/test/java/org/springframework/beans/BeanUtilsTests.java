...
public class BeanUtilsTests {
	...
	@Test
	public void testMineDefine() {
		InvalidProperty property = new InvalidProperty();
		PropertyDescriptor[] descriptors = BeanUtils.getPropertyDescriptors(InvalidProperty.class);
		try {
			for (PropertyDescriptor descriptor : descriptors) {
				if (descriptor.getName().equals("flag1")) {
					descriptor.getWriteMethod().invoke(property, true);
					break;
				}
