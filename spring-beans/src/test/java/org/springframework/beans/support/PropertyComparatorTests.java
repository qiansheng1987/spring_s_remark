...
public class PropertyComparatorTests {
	...
	public void testC() {
		...
		dog2.setAge(9);
		PropertyComparator<Dog> c = new PropertyComparator<>("age", true, true);
		System.out.println(c.compare(dog, dog2));
		SortDefinition sortDefinition = c.getSortDefinition();
		System.out.println(sortDefinition.toString());
